class GalleryImagesController < ApplicationController
  ...
  def index
    ...
    @gallery_images = @business.gallery_images.all
  ...
  def create
    ...
    @gallery_image.business_id = params[:business_id]
    respond_to do |format|
      if @gallery_image.save
        format.html { redirect_to @gallery_image.business, notice: 'Gallery image was successfully created.' }
