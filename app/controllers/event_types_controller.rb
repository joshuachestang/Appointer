class EventTypesController < ApplicationController
  ...
  def index
    ...
    @event_types = @business.event_types.all
  ...
  def create
    ...
    @event_type.business_id = params[:business_id]

    respond_to do |format|
      if @event_type.save
        format.html { redirect_to @event_type.business, notice: 'Event type was successfully created.' }
        format.json { render json: @event_type.business, status: :created, location: @event_type }
      else
