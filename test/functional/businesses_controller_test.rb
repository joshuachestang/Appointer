...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { description: @business.description, name: @business.name, user_id: @business.user_id }
    end
  ...
  test "should update business" do
    put :update, id: @business, business: { description: @business.description, name: @business.name, user_id: @business.user_id }
    assert_redirected_to business_path(assigns(:business))
  end
