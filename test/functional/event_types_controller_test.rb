...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { business_id: @event_type.business_id, duration: @event_type.duration, title: @event_type.title }
    end
  ...
  test "should update event_type" do
    put :update, id: @event_type, event_type: { business_id: @event_type.business_id, duration: @event_type.duration, title: @event_type.title }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
